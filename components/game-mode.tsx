    ...
    <div className="w-full max-w-6xl animate-in fade-in">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        >
          ...
          <h3 className="text-lg font-serif font-bold text-amber-900 dark:text-white mb-2">
            {t("discoveryMode")}
          </h3>
          <p className="text-amber-700 dark:text-amber-300 text-xs font-light">
            {t("discoveryDesc")}
          </p>
          <p className="text-amber-500 dark:text-amber-400 text-xs mt-3 font-serif">
            50 {t("cards")}
          </p>
        </button>
        ...
        >
          ...
          <h3 className="text-lg font-serif font-bold text-rose-900 dark:text-white mb-2">
            {t("romanticMode")}
          </h3>
          <p className="text-rose-700 dark:text-rose-300 text-xs font-light">
            {t("romanticDesc")}
          </p>
          <p className="text-rose-500 dark:text-rose-400 text-xs mt-3 font-serif">
            40 {t("cards")}
          </p>
        </button>
        ...
        >
          ...
          <h3 className="text-lg font-serif font-bold text-pink-900 dark:text-white mb-2">
            {t("deepMode")}
          </h3>
          <p className="text-pink-700 dark:text-pink-300 text-xs font-light">
            {t("deepDesc")}
          </p>
          <p className="text-pink-500 dark:text-pink-400 text-xs mt-3 font-serif">
            50 {t("cards")}
          </p>
        </button>
        ...
        >
          ...
          <h3 className="text-lg font-serif font-bold text-red-900 dark:text-white mb-2">
            {t("spicyMode")}
          </h3>
          <p className="text-red-700 dark:text-red-300 text-xs font-light">
            {t("spicyDesc")}
          </p>
          <p className="text-red-500 dark:text-red-400 text-xs mt-3 font-serif">
            30 {t("cards")}
          </p>
        </button>

        {/* Stories Mode - Now with 100 stories */}
        <button
        ...
        >
          ...
          <h3 className="text-lg font-serif font-bold text-purple-900 dark:text-white mb-2">
            {t("storiesMode")}
          </h3>
          <p className="text-purple-700 dark:text-purple-300 text-xs font-light">
            {t("storiesDesc")}
          </p>
          <p className="text-purple-500 dark:text-purple-400 text-xs mt-3 font-serif">
            100+ {t("cards")}
          </p>
        </button>

        {/* Extended Scenarios Mode */}
        <button
          onClick={() => onModeSelect("scenarios")}
          className="group p-6 bg-white dark:bg-slate-800 rounded-2xl border-2 border-indigo-200 dark:border-indigo-700 hover:border-indigo-400 dark:hover:border-indigo-500 transition-all duration-300 transform hover:scale-105 hover:shadow-xl"
        >
          <ScrollText className="w-10 h-10 text-indigo-500 mb-3 group-hover:fill-indigo-500 transition-all" />
          <h3 className="text-lg font-serif font-bold text-indigo-900 dark:text-white mb-2">
            Extended Scenarios
          </h3>
          <p className="text-indigo-700 dark:text-indigo-300 text-xs font-light">
            Long-form detailed scenarios for deep exploration
          </p>
          <p className="text-indigo-500 dark:text-indigo-400 text-xs mt-3 font-serif">
            10 {t("cards")}
          </p>
        </button>
      </div>
